...
1. Use `usethis::create_from_github("{{< meta book.repo-url >}}")` to fork and clone the repository
2. Use `usethis::pr_init("name-of-my-branch)` to create a new branch for your changes.
3. Edit .qmd, .md, or .Rmd files.
4. If you've created a new file, be sure to add it to one of the chapters in `_quarto.yml`.
